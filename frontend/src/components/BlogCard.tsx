...
export const BlogCard =({authorName , title ,content , publishDate} : BlogProps) => {
    return (
        <div className="flex justify-center">
            <div className=" hover:border-black h-40 w-200 pl-10 pr-10 pt-4 border-2 border-gray-500 m-4 bg-gray-50 rounded-xl pb-39">
            <div className="pb-52">
                    ...
                    <div className="font-libre-baskerville text-3xl pt-4 pb-3">{title}</div>
