        ...
        export const Auth = ({type} : AuthProps)=>{
            ...
            return(<>
                ...
                <div className="flex justify-center flex-col">
                    ...
                    <br></br>
                    <div className="pb-30"> 
                        <InputBox value={userInputs.email} type="text" label="Email" placeholder="Please Enter the email " onChange={(e)=>{setuserInputs({...userInputs , email : e.target.value})}}/>
                        <br></br>
                        <InputBox value={userInputs.password} type="password" label="Password" placeholder="Please Enter the Password " onChange={(e)=>{setuserInputs({...userInputs , password : e.target.value})}}/>
